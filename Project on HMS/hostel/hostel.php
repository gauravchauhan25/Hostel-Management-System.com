            ...
            <div class="form-box login">
                  ...
                  <form method="post" action="register.php">
                        ...
                        <div class="mb-3">
                              ...
                              <select class="form-select form-select-sm transparent-input" name="course" style="padding: 10px;">
                        ...
                        <div class="input-group">
                              <span class="input-group-text transparent-input">Permanent Address</span>
