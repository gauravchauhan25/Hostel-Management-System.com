...
<body style="font-family: 'Times New Roman', Times, serif; ">
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto sidebar">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 color active" href="my-profile.php">
                                    <span class="material-icons-sharp"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0d6efd">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="font-size: 20px;">
                ...
                ?><br>
                    ...
                    <form method="post" action="" class="form-horizontal" onSubmit="return valid();">
                        ...
                        <div class="col-12">
                            <center><button class="btn btn-primary" type="submit" name="update" style="width: 16%; font-size: 17px;">Update Profile</button></center><br /><br />
                        </div>
                    </form>
                <?php
                }
